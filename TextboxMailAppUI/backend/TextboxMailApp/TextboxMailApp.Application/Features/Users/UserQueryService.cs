...
{
  public class UserQueryService(IUserRepository userRepository, IPasswordHasher passwordHasher, ITokenService tokenService) : IUserQueryService
  {
    ...
    public async Task<ApiResult<string>> LoginAsync(LoginQuery request, CancellationToken cancellationToken)
    {
